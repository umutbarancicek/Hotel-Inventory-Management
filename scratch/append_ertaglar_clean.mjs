...
async function appendErtaglarClean() {
  console.log('=== APPENDING ERTAŞLAR DATA WITH CLEAN NAMES (PRESERVING ALL EXISTING DATA) ===');
  ...
  console.log(`Current DB Transactions Count: ${currentTxs.length}`);
  ...
  console.log(`Appended ${addedCount} clean Ertaşlar transactions.`);
  ...
  console.log('✅ Ertaşlar transactions successfully appended with clean names!');
}

appendErtaglarClean().catch(console.error);
