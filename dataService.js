...
export const DataService = {
  init() {
    if (!localStorage.getItem('otel_app_data_v4')) {
      localStorage.setItem('otel_app_data_v4', JSON.stringify(INITIAL_DATA));
    }
  },
  
  getData() {
    return JSON.parse(localStorage.getItem('otel_app_data_v4'));
  },
  
  saveData(data) {
    localStorage.setItem('otel_app_data_v4', JSON.stringify(data));
  },
